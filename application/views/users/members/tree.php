...
<style>
  ...
  #loading img {
    ...
    /* Animasi berputar selama 2 detik secara tak terbatas */
  }
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="dashboard-right" id="dashboard-right">
          <div class="dashboard rounded-md bg-white">
            <!-- product-tab starts -->
            <section class="tab-product m-0">
              <div id="loading" style="display: none;">
                <img src="<?= base_url() ?>assets/images/Spinner-3.gif" alt="Loading..." />
              </div>
              <div class="container pl-0"><!--button onclick="openFullscreen();">Open Video in Fullscreen Mode</button-->
                <h2 class=" capitalize text-2xl font-bold mb-4 text-center">My Entrepreneur Information</h2>
                <hr class=" mb-4">
                <h3 class=" capitalize font-bold !text-black mb-4 text-start mt-4">Lihat Downline Milik Anda</h3>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-1 mb-4">
                  <div class="col-12 md:col-span-3 input-group px-0 mb-2">
                    <select class=" border mx-0 !rounded-full !leading-10 w-full focus:outline-none focus:outline-[#416A25] outline-0 text-center" name="member" id="member" data-placeholder="Select Downline" required>
                      <option value='0'>Tidak Pilih Downline</option>
                    </select>
                  </div>
                  <div class="col-12 p-0 mb-2">
                    <a href="#" id="btn_proses" type="button" class=" rounded-full px-3 py-2 border bg-[#416A25] font-bold text-white linknext !text-center justify-center pt-1 items-center"><i class="fa fa-search mr-2"></i>search</a>
                  </div>
                  <div class="col-12 md:col-span-2 mb-2 px-0">
                    <a href="<?= base_url('users/download') ?>" class=" block text-center px-4 py-2 bg-[#416A25] font-bold text-white rounded-full !w-full hover:bg-[#00461C] focus:outline-none focus:ring focus:border-[#00461C] focus-visible:ring-[#00461C]" id="mc-submit"><i class="fa fa-download mr-2"></i>Download</a>
                  </div>
                  <div class="col-12 md:col-span-2 mb-4 px-0">
                    <a href="<?= base_url('/MembersController/detail_members/' . $data_id) ?>" class=" block text-center px-4 py-2 bg-[#416A25] font-bold text-white rounded-full !w-full hover:bg-[#00461C] focus:outline-none focus:ring focus:border-[#00461C] focus-visible:ring-[#00461C]" id="mc-submit"><i class="fa fa-expand mr-2"></i>See Full Screen</a>
                  </div>
                </div>
                ...
                <!-- <div class="row">
                  <div class="col-sm-6 col-lg-6">
                    <div class="input-group">
                      <select class="form-control option_member" style="width: 250px; border-radius: 999px; margin-right:4px;" name="member" id="member" data-placeholder="Select Downline" required>
                        <option value='0'>Tidak Pilih Downline</option>
                      </select>
                      <a href="#" id="btn_proses" type="button" class="px-4 py-1 border border-[#416A25] font-bold text-[#416A25] linknext !text-center justify-center pt-1 items-center">search</a>
                    </div>
                  </div>
                  <div class="col-sm-12 col-lg-12 my-4">
                    <a href="<?= base_url('users/download') ?>" class="px-4 py-2 bg-[#416A25] font-bold text-white rounded-full" id="mc-submit">Download</a>
                    <p>
                  </div>
                  <div class="col-sm-6 col-lg-6">
