                  ...
                  <div class="container">
                    <div class="row py-4">
                      ...
                      <div class="col-sm-12 col-lg-12">
                        <h4 class=" !my-2 !mx-2">Saldo Family Package & Single Package: </h4>
                        <h4 class="py-2"><span class=" !bg-red-500 text-white !py-2">Rp.<?= ($total_deposit == '' ? 0 : number_format($total_deposit, 0, ',', '.')); ?></span></h4>
                      </div>
                      <!--div class="col-sm-6 col-lg-6"-->
