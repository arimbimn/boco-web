      ...
      <?php if ($v_baner->slider_type == 'image') { ?>
        <div onclick="clickBanner('<?= $v_baner->url_link ?>');">
          <div class="home text-center">
            <img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/banners/' . $v_baner->image_banner) ?>" data-src="<?= smn_baseurl() ?>uploads/banners/<?= $v_baner->image_banner ?>" alt="" class="bg-img blur-up lazyload">
  ...
  <div class="slide-1 home-slider mobile-version">
    <?php foreach ($banner as $v_baner) { ?>
      <?php if ($v_baner->slider_type == 'image') { ?>
        <div onclick="clickBanner('<?= $v_baner->url_link ?>');">
          <div class="home text-center">
            <img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/banners/banner_mobile/' . $v_baner->image_banner_mobile) ?>" alt="" class="bg-img blur-up lazyload">
            <div class="container">
              <div class="row">
                <div class="col">
                  <div class="slider-contain">
          ...
          <?php foreach ($banner_secondary as $v_baner_secondary) { ?>
            <div class="col-md-6">
              <a href="<?= $v_baner_secondary->url_link ?>">
                <div class="collection-banner p-right text-center">
                  <div class="img-part">
                    <img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/banners/banner_mobile/' . $v_baner_secondary->image_banner_mobile) ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                  </div>
                  <div class="contain-banner">
                    <div>
                      <h4><?= $v_baner_secondary->sub_title  ?></h4>
...
<!-- Paragraph-->
<?php $top_colectiontitle = $this->db->where(['id_home_title' => 1])->get('home_title')->row(); ?>
          ...
          <?php foreach ($recommended as $recomen) { ?>
            <div class="product-box">
              <div class="img-wrapper">
                <div class="front">
                  <a href="<?= base_url() ?>product/detail/<?= $recomen->id_product ?>"><img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/product/' . $recomen->image_one) ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                </div>
                <div class="back">
                  <a href="<?= base_url() ?>product/detail/<?= $recomen->id_product ?>"><img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/product/' . $recomen->image_two) ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                </div>
...
<?php if ($banner_paralax) {  ?>
  <section class="p-0">
    <div class="full-banner parallax text-center p-left desktop-version">
      <img src="<?= $CI->base64_encode_image(smn_baseurl() . '/uploads/banners/' . $banner_paralax->image_banner) ?>" alt="" class="bg-img blur-up lazyload">
      <div class="container">
        <div class="row">
          <div class="col">
    ...
    <div class="full-banner parallax text-center p-left mobile-version">
      <img src="<?= $CI->base64_encode_image(smn_baseurl() . '/uploads/banners/banner_mobile/' . $banner_paralax->image_banner_mobile) ?>" alt="" class="bg-img blur-up lazyload">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="banner-contain">
...
<!-- Tab product -->
<?php $productstitle = $this->db->where(['id_home_title' => 2])->get('home_title')->row(); ?>
      ...
      <div class="row">
        <?php foreach ($fiture as $item_fiture) { ?>
          <div class="col-md-4 service-block">
            <div class="media">
              <img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/fiture/' . $item_fiture->image) ?>" alt="" width="20%">
...
<?php if ($blogs) { ?>
  <?php $blogtitle = $this->db->where(['id_home_title' => 3])->get('home_title')->row(); ?>
              ...
              <div class="col-md-12">
                <a href="<?= base_url('blog/detail/' . $item_blog->slug) ?>">
                  <div class="classic-effect">
                    <div>
                      <img src="<?= $CI->base64_encode_image(smn_baseurl() . 'uploads/blogs/' . $item_blog->image_blog) ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                    </div>
                    <span></span>
                  </div>
                </a>
...
<!-- instagram section -->
<?php $igtitle = $this->db->where(['id_home_title' => 4])->get('home_title')->row(); ?>
<!-- blog section -->
<div class="container">
  <div class="row">
    <div class="col">
