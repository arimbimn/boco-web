     ...
     <?php foreach ($banner as $v_baner) { ?>
       <?php if ($v_baner->slider_type == 'image') { ?>
         <div onclick="clickBanner('<?= $v_baner->url_link ?>');">
           <div class="home text-center test">
             <img src="<?= $CI->base64_encode_image_header(smn_baseurl().'uploads/banners/'.$v_baner->image_banner) ?>" fetchpriority="hight" width="1200" height="600" alt="" class="bg-img blur-up lazyload">
             <div class="container">
               <div class="row">
                 <div class="col">
   ...
   <div class="slide-1 home-slider mobile-version">
     <?php foreach ($banner as $v_baner) { ?>
       <?php if ($v_baner->slider_type == 'image') { ?>
         <div onclick="clickBanner('<?= $v_baner->url_link ?>');">
           <div class="home text-center">
             <img src="<?= $CI->base64_encode_image_header(smn_baseurl().'uploads/banners/banner_mobile/'.$v_baner->image_banner_mobile) ?>" fetchpriority="hight" alt="" width="1200" height="600" class="bg-img blur-up lazyload">
             <div class="container">
               <div class="row">
                 <div class="col">
                   <div class="slider-contain">
             ...
             <div class="col-md-6">
               <a href="<?= $v_baner_secondary->url_link ?>">
                 <div class="collection-banner p-right text-center">
                   <div class="img-part">
                     <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/banners/'. $v_baner_secondary->image_banner) ?>" class="img-fluid blur-up lazyload bg-img" alt="">
					 <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image_header(smn_baseurl().'uploads/banners/'.$v_baner_secondary->image_banner) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt=""-->
                   </div>
           ...
           <?php foreach ($banner_secondary as $v_baner_secondary) { ?>
             <div class="col-md-6">
               <a href="<?= $v_baner_secondary->url_link ?>">
                 <div class="collection-banner p-right text-center">
                   <div class="img-part">
				   <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/banners/banner_mobile/'. $v_baner_secondary->image_banner_mobile) ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                     <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image_header(smn_baseurl().'uploads/banners/banner_mobile/'.$v_baner_secondary->image_banner_mobile) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt=""-->
                   </div>
                   <div class="contain-banner">
                     <div>
                       <h4><?= $v_baner_secondary->sub_title  ?></h4>
             ...
             <div class="product-box">
               <div class="img-wrapper">
                 <div class="front">
				   ...
				   <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $recomen->image_one) ?>" class="img-fluid blur-up lazyload bg-img" alt="">
				   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$recomen->image_one) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" width="185" height="274" alt=""-->
				   </a>
                 </div>
                 <div class="back">
                   <a href="<?= base_url() ?>product/detail/<?= $recomen->id_product ?>">
				   <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $recomen->image_two) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
				   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$recomen->image_two) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" width="185" height="274" alt=""-->
				   </a>
                 </div>
 ...
 <?php if ($banner_paralax) {  ?>
   <section class="p-0">
     <div class="full-banner parallax text-center p-left desktop-version">
       <img decoding="async" loading="lazy" src="<?= smn_baseurl() ?>/uploads/banners/<?= $banner_paralax->image_banner ?>" etchpriority="low" alt="" class="bg-img blur-up lazyload">
	   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/banners/'.$banner_paralax->image_banner) ?>" fetchpriority="low" alt="" class="bg-img blur-up lazyload"-->
       <div class="container">
         <div class="row">
           <div class="col">
     ...
     <div class="full-banner parallax text-center p-left mobile-version">
       <img decoding="async" loading="lazy" src="<?= smn_baseurl() ?>/uploads/banners/banner_mobile/<?= $banner_paralax->image_banner_mobile ?>" decoding="async" loading="lazy" alt="" class="bg-img blur-up lazyload">
	   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/banners/banner_mobile/'.$banner_paralax->image_banner_mobile) ?>" fetchpriority="low" alt="" class="bg-img blur-up lazyload"-->
       <div class="container">
         <div class="row">
           <div class="col">
             <div class="banner-contain">
         ...
         <div class="theme-tab">
           ...
           <div class="tab-content-cls">
                     ...
                     <div class="product-box">
                       <div class="img-wrapper">
                         <div class="front">
						   ...
						   <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'/uploads/product/'. $item_product->image_one) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$item_product->image_one) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						   </a>
                         </div>
                         <div class="back">
                           <a href="<?= base_url('product/detail/' . $item_product->id_product) ?>">
						   <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'/uploads/product/'. $item_product->image_two).'?resize=185,274' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$item_product->image_two) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						   </a>
                         </div>
                         <div class="cart-info cart-wrap">
             ...
             <div id="tab-5" class="tab-content">
               <div class="no-slider row">
                 <?php
                  $featured = $this->db->select('id_product,image_one,image_two,image_three,nama_barang,harga,colour_picker')->where('is_featured', 1)->order_by('id_product', 'DESC')->limit(4)->get('product')->result();
                   ...
                   <div class="product-box">
                     <div class="img-wrapper">
                       <div class="front">
						 ...
						 <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $feature->image_one).'?resize=185,274' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						 <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$feature->image_one) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						 </a>
                       </div>
                       <div class="back">
                         <a href="<?= base_url() ?>product/detail/<?= $feature->id_product ?>">
						 <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $feature->image_two).'?resize=185,274' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						 <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$feature->image_two) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						 </a>
                       </div>
                       <div class="cart-info cart-wrap">
                   ...
                   <div class="product-box">
                     <div class="img-wrapper">
                       <div class="front">
						 ...
						 <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $best_seller->image_one).'?resize=185,274' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						 <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$best_seller->image_one) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						 </a>
                       </div>
                       <div class="back">
                         <a href="<?= base_url() ?>product/detail/<?= $best_seller->id_product ?>">
						 <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/product/'. $best_seller->image_two).'?resize=185,274' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
						 <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/product/'.$best_seller->image_two) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="" width="185" height="274"-->
						 </a>
                       </div>
                       <div class="cart-info cart-wrap">
                         <!-- <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> -->
       ...
       <div class="row">
         <?php foreach ($fiture as $item_fiture) { ?>
           <div class="col-md-4 service-block">
             <div class="media">
               <img decoding="async" loading="lazy" src="<?= smn_baseurl() ?>uploads/fiture/<?= $item_fiture->image ?>" fetchpriority="low" alt="" width="20%">
			   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/fiture/'.$item_fiture->image) ?>" fetchpriority="low"  alt="" width="20%"-->
               ...
               <div class="col-md-12">
                 <a href="<?= base_url('blog/detail/' . $item_blog->slug) ?>">
                   <div class="classic-effect">
                     <div>
                       <img decoding="async" loading="lazy" src="<?= str_replace(array('https://' , 'http://') , 'https://i1.wp.com/',smn_baseurl().'uploads/blogs/'.$item_blog->image_blog).'?resize=1600,700' ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt="">
					   <!--img decoding="async" loading="lazy" src="<!?= $CI->base64_encode_image(smn_baseurl().'uploads/blogs/'.$item_blog->image_blog) ?>" fetchpriority="low" class="img-fluid blur-up lazyload bg-img" alt=""-->
                     </div>
                     <span></span>
                   </div>
                 </a>
