           ...
           <?php foreach ($recommended as $recomen) { ?>
             <div class="product-box">
               <div class="img-wrapper">
                 <div class="front">
                   <a href="<?= base_url() ?>product/detail/<?= $recomen->id_product ?>"><img src="<?= smn_baseurl() ?>uploads/product/<?= $recomen->image_one ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                 </div>
                 <div class="back">
                   <a href="<?= base_url() ?>product/detail/<?= $recomen->id_product ?>"><img src="<?= smn_baseurl() ?>uploads/product/<?= $recomen->image_two ?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                 </div>
 ...
 <?php if ($banner_paralax) {  ?>
   <section class="p-0">
     ...
     <div class="full-banner parallax text-center p-left mobile-version">
       <img src="<?= smn_baseurl() ?>/uploads/banners/banner_mobile/<?= $banner_paralax->image_banner_mobile ?>" alt="" class="bg-img blur-up lazyload">
       <div class="container">
         <div class="row">
           <div class="col">
             <div class="banner-contain">
