               ...
               <div class="row">
                 <div class="col-lg-8">
                   <div class="product-slick">
                     <div>
                       <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-0" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_one ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_one ?>" width="500" />
                     </div>
                     <div>
                       <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-1" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_two ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_two ?>" width="500" />
                     </div>
                     <div>
                       <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-2" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_three ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_three ?>" width="500" />
                     </div>
                     <?php if ($detail_product->image_four) { ?>
                       <div>
                         <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-3" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_four ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_four ?>" width="500" />
                       </div>
                     <?php } ?>
                     <?php if ($detail_product->image_five) { ?>
                       <div>
                         <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-4" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_five ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_five ?>" width="500" />
                       </div>
                     <?php } ?>
                     <?php if ($detail_product->image_six) { ?>
                       <div>
                         <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-5" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_six ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_six ?>" width="500" />
                       </div>
                     <?php } ?>
                     <?php if ($detail_product->image_seven) { ?>
                       <div>
                         <img class="zoom-img img-fluid blur-up lazyload image_zoom_cls-6" src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_seven ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_seven ?>" width="500" />
                       </div>
                     <?php } ?>
                       ...
                       <div class="slider-nav" id="gallery_01">
                         <div>
                           <a href="#" class="elevatezoom-gallery" data-update="" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_one ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_one ?>">
                             <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_one ?>" class="img-fluid blur-up lazyload" />
                           </a>
                         </div>
                         <div>
                           <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_two ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_two ?>">
                             <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_two ?>" class="img-fluid blur-up lazyload" />
                           </a>
                         </div>
                         <div>
                           <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_three ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_three ?>">
                             <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_three ?>" class="img-fluid blur-up lazyload" />
                           </a>
                         </div>
                         ...
                         <?php if ($detail_product->image_four) { ?>
                           <div>
                             <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_four ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_four ?>">
                               <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_four ?>" class="img-fluid blur-up lazyload" />
                             </a>
                           </div>
                         <?php } ?>
                         <?php if ($detail_product->image_five) { ?>
                           <div>
                             <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_five ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_five ?>">
                               <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_five ?>" class="img-fluid blur-up lazyload" />
                             </a>
                           </div>
                         <?php } ?>
                         <?php if ($detail_product->image_six) { ?>
                           <div>
                             <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_six ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_six ?>">
                               <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_six ?>" class="img-fluid blur-up lazyload" />
                             </a>
                           </div>
                         <?php } ?>
                         <?php if ($detail_product->image_seven) { ?>
                           <div>
                             <a href="#" class="elevatezoom-gallery" data-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_seven ?>" data-zoom-image="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_seven ?>">
                               <img src="<?= smn_baseurl() ?>uploads/product/<?= $detail_product->image_seven ?>" class="img-fluid blur-up lazyload" />
                             </a>
                           </div>
                         <?php } ?>
                 ...
                 <div class="col-lg-4 rtl-text">
                   ...
                   <div class="product-right">
                     <h2><?= $detail_product->nama_barang ?></h2>
                     ...
                     <?php
                      ...
                      if ($this->ion_auth->logged_in()) {
                        ...
                        if ($cekDiskonItem) {
                          ...
                          echo '<h3>IDR ' . number_format($detail_product->harga, 0)  . ' </h3>';
                     ...
                     <?php $colorRelate = $this->db->select('product.id_product as idcolor, product.colour, product.colour_picker')->where(['identity_product' => $detail_product->identity_product])->where(['is_active' => 1])->get('product')->result(); ?>
                           ...
                           <div class="container-inner">
                             ...
                             <?php
                              foreach ($productSize as $key => $size) {  ?>
                               <?php $cekTotal = $this->db->select_sum('jumlah_stok')->select('product_stok.jumlah_stok as jml_last')->where(['id_product' => $detail_product->id_product])->where(['id_product_attribute' => $size->id_product_attribute])->get('product_stok')->row(); ?>
                               <?php
                                //  var_dump($cekTotal)
                                ?>
                               <label class="custom-radio-button-container" style="margin-left:0px;margin-right:10px;">
                                 <input type="radio" name="size" value="<?= $size->id_product_attribute ?>" <?php if ($detail_product->indent == 1) {  ?> <?php } else if ($cekTotal->jumlah_stok < 1) { ?> disabled <?php  } ?>>
                                 <span data-id="<?= $size->id_product_attribute ?>" data-indent="<?= $detail_product->indent ?>" class="<?php if ($detail_product->indent == 1) {  ?> custom-radio-button <?php } else if ($cekTotal->jumlah_stok < 1) { ?> custom-radio-button-no-stock <?php  } else { ?>  custom-radio-button <?php } ?> radio-<?= str_replace(['.', ' '], '-', $size->size)  ?>"></span>
                               </label>
                               ...
                               <?php } elseif ($detail_product->indent == 1) {  ?>
                     ...
                     <div>
                       <button type="submit" id='button-addtocart' <?= $isdisabled ?> data-toggle="modal" data-target="#addtocart" class="btn btn-solid"><?= lang('add_to_cart_produk') ?></button>
                     </div>
                     <?php echo form_close() ?>
