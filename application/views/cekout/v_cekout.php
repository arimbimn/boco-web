        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="row check-out">
                ...
                <div class="checkout-details">
                  <div class="order-box">
                    ...
                    ?>
                      ...
                      <tbody>
                        <tr class="qty">
                          <td><?= $items['name'] ?>, <?= lang('size_produk') ?> : <?= $size->size ?>
                            <br>Alamat Pengiriman : <? $items['alamat'] ?>
                            <br> <?php if ($items['options']['Indent'] != 0) {  ?>
              ...
              <div class="col-lg-12 col-sm-12 col-xs-12 mt-1 mb-1 p-0">
                <div class="checkout-details">
                      ...
                      <div class="row">
                        <div class="col-md-6 mt-0 mb-2">
                          <?php if ($this->session->userdata('reseller') == "") { ?>
                            <button type=" button" class="btn-outline-danger btn pull-left" data-toggle="modal" data-target="#exampleModalCenter"><?= lang('get_more_discount') ?></button>
                          <?php } ?>
                        </div>
                        <!-- <ul class="sub-total">
                    </ul>
                    <ul class="total"> -->
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <?php } ?><p>
                            <div class="text-right"><button type="submit" class="btn-danger btn bvoucher" <?= $sp_disable ?>><?= lang('use_voucher') ?> <!--?php echo $this->session->userdata('refferemail') ?--></button></div>
                          </div>
                          <?= form_close() ?>
                        </div>
                      </div>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 p-0">
                  <div class="checkout-details">
...
<script>
  ...
  function tampil_alamat() {
    $.ajax({
      url: '<?php echo base_url() ?>CekOutController/saveCekoutXendit',
      type: 'POST',
      dataType: 'json',
      cache: false,
