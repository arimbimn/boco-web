                ...
                <nav id="main-nav">
                  ...
                  <ul id="main-menu" class="sm pixelstrap sm-horizontal">
					...
					<?php if($this->session->userdata('user_id')==''){?>
					 <li>
                      <a href="<?= base_url('/reseller') ?>">Reseller</a>
						  <ul>
							 <li>
								<a href="<?= base_url('/login_reseller') ?>">Login Reseller</a>
							 </li>
							 <li>
								<a href="<?= base_url('/reg_reseller') ?>">Daftar Reseller</a>
							 </li>
						  </ul>
                    </li>
					<?php } ?>
                ...
                <div class="icon-nav">
                  <ul>
                    <li class="onhover-div mobile-search">
                      <div><img src="<?= base_url() ?>assets/images/icon/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i></div>
                    ...
                    <li class="onhover-div mobile-setting">
                      <?php if ($this->ion_auth->logged_in()) { ?>
                        ...
                        <?php  } else { ?>
                          <div><img src="<?= base_url() ?>assets/images/icon/bell.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-bell"></i></div>
                        <?php  } ?>
                      <?php  } else { ?>
                        <div><img src="<?= base_url() ?>assets/images/icon/bell.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-bell"></i></div>
                      <?php   } ?>
