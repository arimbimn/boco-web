...
<head>
  ...
  <link rel="icon" href="<?= script_baseurl() ?>assets/images/1609746656-favicon.png" type="image/x-icon">
  <link rel="shortcut icon" href="<?= script_baseurl() ?>assets/images/1609746656-favicon.png" type="image/x-icon">
  <title><?= $title ?></title>
  ...
  <!-- Icons -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/fontawesome.css">

  <!--Slick slider css-->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/slick.css">
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/slick-theme.css">

  <!-- Animate icon -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/animate.css">

  <!-- Size css -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/stylesize.css">

  <!-- Price range icon -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/price-range.css">

  <!-- Themify icon -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/themify-icons.css">

  <!-- Bootstrap css -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/bootstrap.css">

  <link rel="stylesheet" href="<?= script_baseurl() ?>assets/css/magnific-popup.css">

  <!-- Theme css -->
  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/color1.css" media="screen" id="color">

  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/chosen.css">

  <link rel="stylesheet" type="text/css" href="<?= script_baseurl() ?>assets/css/datepicker3.css">

  <!-- latest jquery-->
  <script src="<?= script_baseurl() ?>assets/js/jquery-3.3.1.min.js"></script>
...
<body>
          ...
          <div class="main-menu">
            <div class="menu-left">
              <div class="brand-logo">
                <a href="<?= base_url() ?>"><img src="<?= script_baseurl('assets/images/icon/logo.png') ?>" class="img-fluid blur-up lazyload" alt=""></a>
              </div>
            </div>
                ...
                <div class="icon-nav">
                  <ul>
                    <li class="onhover-div mobile-search">
                      <div><img src="<?= script_baseurl() ?>assets/images/icon/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i></div>
                    ...
                    <li class="onhover-div mobile-setting">
                      <?php if ($this->ion_auth->logged_in()) { ?>
                        ...
                        ?>
                        <?php if ($notif) { ?>
                          <div><img src="<?= script_baseurl() ?>assets/images/icon/bell.png" class="img-fluid blur-up lazyload" alt="">
                        ...
                        <?php  } else { ?>
                          <div><img src="<?= script_baseurl() ?>assets/images/icon/bell.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-bell"></i></div>
                        <?php  } ?>
                      <?php  } else { ?>
                        <div><img src="<?= script_baseurl() ?>assets/images/icon/bell.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-bell"></i></div>
                      <?php   } ?>
                    ...
                    <li class="onhover-div mobile-cart">
                      <div>
                        <?php if (!empty($this->cart->contents())) { ?>
                          <img src="<?= script_baseurl() ?>assets/images/icon/cart.png" class="img-fluid blur-up lazyload" alt="">
                        <?php } else { ?>
                          <img src="<?= script_baseurl() ?>assets/images/icon/cart.png" class="img-fluid blur-up lazyload" alt="">
                        <?php } ?>
          ...
          <div class="col offset-xl-1">
            <div class="sub-title">
              ...
              <div class="footer-contant">
                <ul>
                  <?php if ($this->ion_auth->logged_in()) { ?>
                    <li><a href="#" data-lng="es"><?= lang('MyAccount') ?></a></li>
                    <li><a href="<?= base_url('auth/logout') ?>" data-lng="es"><?= lang('LogOut') ?></a></li>
                  <?php } else { ?>
                    <li><a href="<?= base_url('login') ?>" data-lng="en"><?= lang('login') ?></a></li>
                    <li><a href="<?= base_url('register') ?>" data-lng="en"><?= lang('register') ?></a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-5 col-md-5 col-sm-12">
            <div class="footer-end">
              <p>PT. CHOSEN MITRA ABADI <br>
                <i class="fa fa-map-marker" aria-hidden="true"></i>
                Jl. Raya Serang Km.12 No.18 <br>
                Kampung Kadu, Desa Bunder <br>
                Cikupa Tangerang <br>
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-md-4 col-sm-12">
            <div class="payment-card-bottom">
              <ul>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/visa.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/mastercard.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-jcb.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-bca.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-bni.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-mandiri.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-bri.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-permata.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-ovo.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-dana.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-shopeepay.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-linkaja.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-qris.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-alfamart.png" alt="" style="height: 15px"></a>
                </li>
                <li class="mt-4 mb-1">
                  <a><img src="<?= script_baseurl() ?>assets/images/icon/logo-indomaret.png" alt="" style="height: 15px"></a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <!-- Size jquery-->
  <script src="<?= script_baseurl() ?>assets/js/scriptsize.js"></script>

  <!-- fly cart ui jquery-->
  <script src="<?= script_baseurl() ?>assets/js/jquery-ui.min.js"></script>

  <!-- exitintent jquery-->
  <script src="<?= script_baseurl() ?>assets/js/jquery.exitintent.js"></script>

  <!-- <script src="<?= base_url() ?>assets/js/exit.js"></script> -->

  <!-- popper js-->
  <script src="<?= script_baseurl() ?>assets/js/popper.min.js"></script>

  <!-- slick js-->
  <script src="<?= script_baseurl() ?>assets/js/slick.js"></script>

  <script src="<?= script_baseurl() ?>assets/js/jquery.magnific-popup.js"></script>

  <script src="<?= script_baseurl() ?>assets/js/zoom-gallery.js"></script>

  <!-- menu js-->
  <script src="<?= script_baseurl() ?>assets/js/menu.js"></script>

  <!-- lazyload js-->
  <script src="<?= script_baseurl() ?>assets/js/lazysizes.min.js"></script>

  <!-- price range js -->
  <script src="<?= script_baseurl() ?>assets/js/price-range.js"></script>

  <!-- Bootstrap js-->
  <script src="<?= script_baseurl() ?>assets/js/bootstrap.js"></script>

  <!-- Bootstrap Notification js-->
  <script src="<?= script_baseurl() ?>assets/js/bootstrap-notify.min.js"></script>
  ...
  <!-- Fly cart js-->
  <script src="<?= script_baseurl() ?>assets/js/fly-cart.js"></script>



  <!-- Theme js-->
  <script src="<?= script_baseurl() ?>assets/js/script.js"></script>

  <script src="<?= script_baseurl() ?>assets/js/chosen.jquery.min.js"></script>

  <!-- <script src="<? //= base_url() 
                    ?>assets/js/jquery.datetimepicker.full.js"></script> -->

  <script src="<?= script_baseurl() ?>assets/js/bootstrap-datepicker.js"></script>

  <?php if ($title != 'Cekout | Bocorocco Pillow Concept') { ?>
    <script src="<?= script_baseurl() ?>assets/js/additional.js"></script>
  <?php } ?>

  <script>
    var baseurl = '<?= script_baseurl() ?>';
  ...
  ?>
    <script src="<?= script_baseurl() ?>assets/js/jquery.instagramFeed.p.min.js"></script>

    <!-- <script>
      $.instagramFeed({
        'proxy_image_url': "<?= script_baseurl() ?>assets/instamedia/instamedia.php",
        'username': 'bocorocco',
        'container': "#instagram",
