 ...
 */
$config['reseller_group']              = 'reseller';
$config['site_title']                 = "bocorocco";       // Site Title, example.com
$config['admin_email']                = "noreplyinfo@bocorocco-italia.com";//"info@graphie.co.id"; // Admin Email, admin@example.com
...
$config['email_config'] = array(
  'protocol' => 'smtp',
  'smtp_host' => 'ssl://smtp.gmail.com',//'ssl://mail.graphie.co.id',
  'smtp_user' => 'noreplyinfo@bocorocco-italia.com',//'info@graphie.co.id',
  'smtp_pass' => 'sfsrzqlhuucabiyt',//'ZMqE25htnE',
  'smtp_port' => 465,//4465,
  'smtp_crypto' => 'tsl',
  'mailtype'  => 'html',
  'charset' => 'utf-8',
